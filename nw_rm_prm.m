...
num_usrfrm = num_data_sym_per_cw / num.num_qamsym_usr;      % number of required user frames (previously num_slot, number of slots)
t_tb = num_usrfrm * num.t_usrfrm;                           % transfer block length (sec)
