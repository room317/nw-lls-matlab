...
function ch_est_rmse = test_dd_basic_r1(test_synch, test_singletone, test_scope, test_seed, test_timesaving)
...
if isempty(test_singletone)
    ...
    tx_sym_dd(test_singletone(1)+1, test_singletone(2)+1) = sqrt(num_subc*num_sym);
end
...
if isempty(test_singletone)
    ...
    ch_est_dd = circshift(rx_sym_dd, (-1)*test_singletone);
